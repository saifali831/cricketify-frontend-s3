...
export default function HomePage() {
    ...
    const loadData=()=>{
        axios
        .get(`https://cricketify-server.herokuapp.com/api/post/get`)
        .then(result=>{
    ...
    const getSearch=()=>{
        axios
        .get(`https://cricketify-server.herokuapp.com/api/post/search?query=${search.query}&filter=${search.selectedOption}`)
        .then(result=>{
            setPost({data:result.data})
        })
        .catch(error =>{
    ...
    const postComment=(text,postId)=>{
        ...
        axios
        .post("https://cricketify-server.herokuapp.com/api/post/comment/create",{postId,text,userName})
        .then((result)=>{
